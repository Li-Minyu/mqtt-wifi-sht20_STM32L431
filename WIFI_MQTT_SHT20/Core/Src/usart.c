...
uint8_t 		g_uart1_bytes=0;

uint8_t 	    g_uart2_rxch;
char			g_uart2_rxbuf[256];
uint8_t 		g_uart2_bytes=0;

uint8_t 	    g_uart3_rxch;
char			g_uart3_rxbuf[256];
uint8_t 		g_uart3_bytes=0;

uint8_t 	    g_lpuart1_rxch;
char            g_lpuart1_rxbuf[256];
uint8_t         g_lpuart1_bytes=0;
/* USER CODE END 0 */
...
//		}
//		HAL_UART_Receive_IT(&huart1,&s_uart1_rxch,1);/*浣胯兘涓嬩竴娆�?�腑鏂帴鏀?*/
//	}
...
//		}
//		HAL_UART_Receive_IT(&huart2,&s_uart2_rxch,1);/*浣胯兘涓嬩竴娆�?�腑鏂帴鏀?*/
//	}
//}
