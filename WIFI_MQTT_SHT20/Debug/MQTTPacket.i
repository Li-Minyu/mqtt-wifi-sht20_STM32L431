...
# 19 "../Core/Src/mqtt/MQTTPacket.c" 2
...
# 20 "../Core/Src/mqtt/MQTTPacket.c" 2
...
# 22 "../Core/Src/mqtt/MQTTPacket.c" 2
...
# 215 "../Core/Src/mqtt/MQTTPacket.c"
int readMQTTLenString(MQTTString* mqttstring, unsigned char** pptr, unsigned char* enddata)
{
 int rc = 0;
 ...
 mqttstring->cstring = 
# 231 "../Core/Src/mqtt/MQTTPacket.c" 3 4
                      ((void *)0)
# 231 "../Core/Src/mqtt/MQTTPacket.c"
                          ;
 ;
 return rc;
}
...
# 260 "../Core/Src/mqtt/MQTTPacket.c"
...
# 290 "../Core/Src/mqtt/MQTTPacket.c"
int MQTTPacket_read(unsigned char* buf, int buflen, int (*getfn)(unsigned char*, int))
{
 int rc = -1;
 MQTTHeader header = {0};
...
# 362 "../Core/Src/mqtt/MQTTPacket.c"
int MQTTPacket_readnb(unsigned char* buf, int buflen, MQTTTransport *trp)
{
 int rc = -1, frc;
 MQTTHeader header = {0};
