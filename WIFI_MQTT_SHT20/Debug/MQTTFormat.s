...
.LC14:
	...
	.section	.data.MQTTPacket_names,"aw"
	.align	2
...
MQTTPacket_getName:
.LFB3:
	.file 1 "../Core/Src/mqtt/MQTTFormat.c"
	.loc 1 32 1
	.cfi_startproc
...
.L6:
	...
	cmp	r3, #0
	beq	.L7
	.loc 1 51 63 discriminator 1
	ldr	r3, [r7, #4]
	ldr	r3, [r3, #68]
	.loc 1 51 36 discriminator 1
	cmp	r3, #0
	ble	.L7
	.loc 1 52 15
	ldr	r3, [r7, #20]
...
.Letext0:
	...
	.file 3 "../Core/Src/mqtt/MQTTPacket.h"
	.file 4 "../Core/Src/mqtt/MQTTConnect.h"
	.file 5 "f:\\app\\stm32cubeide_1.12.0\\stm32cubeide\\plugins\\com.st.stm32cube.ide.mcu.externaltools.gnu-tools-for-stm32.10.3-2021.10.win32_1.0.200.202301161003\\tools\\arm-none-eabi\\include\\stdio.h"
...
.LASF991:
	.ascii	"long int\000"
.LASF1040:
	.ascii	"../Core/Src/mqtt/MQTTFormat.c\000"
.LASF807:
