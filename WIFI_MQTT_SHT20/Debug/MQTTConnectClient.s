...
.LFB3:
	.file 1 "../Core/Src/mqtt/MQTTConnectClient.c"
	.loc 1 28 1
	.cfi_startproc
...
.L4:
	...
	cmp	r3, #0
	bne	.L5
	.loc 1 41 62 discriminator 1
	ldr	r3, [r7, #4]
	ldr	r3, [r3, #72]
	.loc 1 41 32 discriminator 1
	cmp	r3, #0
	beq	.L6
.L5:
	.loc 1 42 10
...
.LASF1074:
	.ascii	"../Core/Src/mqtt/MQTTConnectClient.c\000"
.LASF53:
