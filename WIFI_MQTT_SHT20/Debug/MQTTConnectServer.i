# 1 "../Core/Src/mqtt/MQTTConnectServer.c"
...
# 1 "../Core/Src/mqtt/MQTTConnectServer.c"
# 17 "../Core/Src/mqtt/MQTTConnectServer.c"
...
# 18 "../Core/Src/mqtt/MQTTConnectServer.c" 2
...
# 19 "../Core/Src/mqtt/MQTTConnectServer.c" 2
...
# 20 "../Core/Src/mqtt/MQTTConnectServer.c" 2

#define min(a,b) ((a < b) ? a : b)
# 30 "../Core/Src/mqtt/MQTTConnectServer.c"
...
int MQTTPacket_checkVersion(MQTTString* protocol, int version)
{
 ...
 if (version == 3 && memcmp(protocol->lenstring.data, "MQIsdp",
   ((6 < protocol->lenstring.len) ? 6 : protocol->lenstring.len)) == 0)
  rc = 1;
 else if (version == 4 && memcmp(protocol->lenstring.data, "MQTT",
   ((4 < protocol->lenstring.len) ? 4 : protocol->lenstring.len)) == 0)
  rc = 1;
 return rc;
}
# 51 "../Core/Src/mqtt/MQTTConnectServer.c"
int MQTTDeserialize_connect(MQTTPacket_connectData* data, unsigned char* buf, int len)
{
 MQTTHeader header = {0};
...
# 119 "../Core/Src/mqtt/MQTTConnectServer.c"
int MQTTSerialize_connack(unsigned char* buf, int buflen, unsigned char connack_rc, unsigned char sessionPresent)
{
 MQTTHeader header = {0};
 int rc = 0;
