...
.Ltext0:
	...
	.align	1
	.global	MQTTSerialize_unsubscribeLength
	.syntax unified
	.thumb
	.thumb_func
...
.LFB3:
	.file 1 "../Core/Src/mqtt/MQTTUnsubscribeClient.c"
	.loc 1 29 1
	.cfi_startproc
...
.L3:
	...
	bl	MQTTstrlen
	mov	r3, r0
	.loc 1 34 12 discriminator 3
	adds	r3, r3, #2
	.loc 1 34 7 discriminator 3
	ldr	r2, [r7, #8]
	add	r3, r3, r2
	str	r3, [r7, #8]
	.loc 1 33 25 discriminator 3
	ldr	r3, [r7, #12]
	adds	r3, r3, #1
	str	r3, [r7, #12]
.L2:
...
.LFE3:
	...
	.align	1
	.global	MQTTSerialize_unsubscribe
	.syntax unified
	.thumb
	.thumb_func
...
.L9:
	...
	ldm	r3, {r1, r2, r3}
	bl	writeMQTTString
	.loc 1 75 25 discriminator 3
	ldr	r3, [r7, #32]
	adds	r3, r3, #1
	str	r3, [r7, #32]
.L8:
	.loc 1 75 2 discriminator 1
	ldr	r2, [r7, #32]
	ldr	r3, [r7, #48]
	cmp	r2, r3
	blt	.L9
...
.LFE4:
	...
	.align	1
	.global	MQTTDeserialize_unsuback
	.syntax unified
	.thumb
	.thumb_func
...
.LASF1043:
	.ascii	"../Core/Src/mqtt/MQTTUnsubscribeClient.c\000"
.LASF68:
...
.LASF993:
	.ascii	"CONNACK\000"
.LASF1046:
	.ascii	"MQTTSerialize_unsubscribeLength\000"
.LASF730:
