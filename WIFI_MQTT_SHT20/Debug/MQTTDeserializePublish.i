# 1 "../Core/Src/mqtt/MQTTDeserializePublish.c"
...
# 1 "../Core/Src/mqtt/MQTTDeserializePublish.c"
# 17 "../Core/Src/mqtt/MQTTDeserializePublish.c"
...
# 18 "../Core/Src/mqtt/MQTTDeserializePublish.c" 2
...
# 19 "../Core/Src/mqtt/MQTTDeserializePublish.c" 2
...
# 20 "../Core/Src/mqtt/MQTTDeserializePublish.c" 2

#define min(a,b) ((a < b) ? 1 : 0)
# 36 "../Core/Src/mqtt/MQTTDeserializePublish.c"
...
# 41 "../Core/Src/mqtt/MQTTDeserializePublish.c" 3 4
                         ((void *)0)
# 41 "../Core/Src/mqtt/MQTTDeserializePublish.c"
                             ;
 int rc = 0;
 int mylen = 0;
...
# 82 "../Core/Src/mqtt/MQTTDeserializePublish.c"
int MQTTDeserialize_ack(unsigned char* packettype, unsigned char* dup, unsigned short* packetid, unsigned char* buf, int buflen)
{
 MQTTHeader header = {0};
 unsigned char* curdata = buf;
 unsigned char* enddata = 
# 86 "../Core/Src/mqtt/MQTTDeserializePublish.c" 3 4
                         ((void *)0)
# 86 "../Core/Src/mqtt/MQTTDeserializePublish.c"
                             ;
 int rc = 0;
 int mylen;
